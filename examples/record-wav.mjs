...
import { AudioTee, getPermissionStatus, isPermissionAvailable, openSystemSettings } from '../dist/index.js'
...
function checkPermission() {
  if (!isPermissionAvailable()) {
    console.log('⚠️  Permission API not available, proceeding anyway...\n')
    return true
  }
